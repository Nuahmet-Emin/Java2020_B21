...
public class LocalRestaurants {
    ...
    public static void main(String[] args) {
        ...
        Restaurant restaurant = new Restaurant("Muhtar");
        restaurant.hireServer(new Server("Mini",25,'F',25, "Server","123"));
...
/*
 Create a class LocalRestaurant that has a main method with the following:
            ...
            - Create an array of servers with their information set. Add those initial servers to the
            ArrayList of the Restaurant object
